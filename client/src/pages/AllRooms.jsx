...
// handle changes for filters and sorting
    ...
    },[rooms,selectedFilters,searchParams,selectedSort,searchParams])
  ...
  return (
    ...
    <div>
        ...
        <div key={room._id} className='flex flex-col md:flex-row items-start py-10  gap-6 border-b border-gray-300 last:pb-30 last:border-0 '>
            ...
            src={room.images[0]} alt="hotel-img" title='view Room Details' className='max-w-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer'/>
