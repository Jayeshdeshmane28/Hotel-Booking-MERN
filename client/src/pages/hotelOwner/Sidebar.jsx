...
const Sidebar = () => {
  ...
  return (
    <div className='md:w-64 w-16 border-r h-full text-base borsder-gray-300 pt-4 flex flex-col transition-all duration-300'>
        {sidebarLinks.map((item, index)=>(
            <NavLink to={item.path} end='/owner' className={({isActive})=>
